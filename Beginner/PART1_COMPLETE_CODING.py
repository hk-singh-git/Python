...
a = 12
## The fallowing 3 examples test if a number a is divisible by 6
...
## 3rd Example
if not (a % 2  and a % 3 ): #the truthiness of an expression: a % 2 is equal to bool(a %2)
    print('Example 2: a is divisible by 2 and 3 (or by 6)')
...
l1 = ['a', 'b', 'c']
l1.clear()      # removes all element from the list
...
## Removes the first occurance and doesn't return an item of the list
print(list1)        #[1, 2.2, 'abc', 5, [6, 7], 5.2, 'x', 'y']
...
def my_func2():
    ...
    print(f'x is {x}')  # this is NOT "x" varible from the global namespace
...
class Robot:
    ...
    def __init__(self, name=None, year=None): # this is the constructor, it's automatically called when creating an instance
        self.name = name        # instance attribute, default None
        self.year = year        # instance attribute, default None
        Robot.population += 1   # incrementing class attribute when creating a new object

    def __del__(self):  # this is de destructor, it's automatically called then the object gets out of scope
    ...
    def __str__(self):          # magic method, called automatically when printing an object
